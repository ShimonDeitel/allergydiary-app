        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let entry = FlareUpEntry(title: newTitle.isEmpty ? "Untitled" : newTitle, note: newNote, value: newValue)
                        if store.add(entry) {
                            showAddSheet = false
                        } else {
                            showAddSheet = false
